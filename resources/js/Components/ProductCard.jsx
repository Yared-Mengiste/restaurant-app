...
export default function ProductCard({ product, auth}) {
    ...
    return (
        ...
        >
            {/* IMAGE CONTAINER */}
            {/* Mobile: 4:3 ratio for more vertical density | Tablet+: 16:10 for cinematic look */}
            <div className="relative aspect-[4/3] md:aspect-[16/10] rounded-xl md:rounded-2xl overflow-hidden mb-3 md:mb-5 bg-surface-container-high shadow-lg border border-white/5">
                ...
                {/* BADGE: Smaller and tighter on mobile */}
                {product.is_featured && (
                ...
                {/* VIGNETTE: Always slightly visible on mobile for readability, deepens on hover */}
            ...
            <div className="flex justify-between items-start px-1">
                <div className="flex flex-col gap-0.5 md:gap-1 max-w-[70%]">
                    {/* Title: Scales from base to large */}
                    ...
                    {/* Category: Hidden on very small screens if necessary, or kept tiny */}
