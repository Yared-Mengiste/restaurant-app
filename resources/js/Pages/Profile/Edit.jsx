            ...
            <main className="pt-20 md:pt-32 pb-40 px-4 sm:px-6 md:px-12 max-w-[1920px] mx-auto min-h-screen">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    <div className="lg:col-span-8 space-y-12">
                        ...
                        <div className="bg-surface-container-low p-4 sm:p-8 rounded-xl md:rounded-2xl border border-outline-variant/10 shadow-sm">
                        ...
                        {/* Danger Zone Section */}
                        <div className="bg-surface-container-low p-4 sm:p-8 rounded-xl md:rounded-2xl border border-error/10 shadow-sm border-dashed">
